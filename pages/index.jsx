...
const homepageAssetsSymbols = [
  ...
  { symbol: 'fvm', mainnet: true, testnet: true, hide: false },
...
const Home = () => {
  ...
  const handleCommodityClick = (symbol) => {
...
text-transparent xl:text-[4rem] md:text-5xl font-bold font-polySans md:max-w-5xl text-center text-[22px] max-w-[575px]">
              ...
              <p className='text-white pb-5'> You can swap any token using FVM Finance DEX</p>
              <Link href="/swap">
...
text-transparent xl:text-[4rem] md:text-5xl font-bold font-polySans md:max-w-5xl text-center text-[22px] max-w-[575px]">
              ...
              <p className='text-white pb-5'>
                FVM Finance Prediction Market is built on Ethereum Chain. At the moment the markets are for cryptocurrencies, but in the future they could be for anything. Everyone can create
...
text-transparent xl:text-[4rem] md:text-5xl font-bold font-polySans md:max-w-5xl text-center text-[22px] max-w-[575px]">
              ...
              <p className='text-white pb-5'> It has a unique lottery feature built using **Space & Time** to create dynamic NFT for the winner users.
                At the end of each week the smart contract will make select the closest ticket to the last 2 digit of the number of Contracts deployed on Ethereum Mainnet by that time of that day and pay the owner of that ticket. </p>
              <Link href="/bank/transfer">
                <a className="inline-flex justify-center align-middle items-center m-2 p-5 text-sm font-medium text-center text-white bg-black rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                  Try Your Luck
                  <BsFillArrowRightCircleFill className="ml-3" />							</a>
      ...
      <Container>
        <div className='text-right text-[32px] py-4'>Token Market</div>
        ...
        <Boxes>
          {homepageAssetsSymbols.map(asset => {
            return (
              <Box
                onClick={
                  asset.testnet || chain?.network === 'fvm' || !chain
                    ? () => handleClick(asset.symbol)
                    : () => { }
                }
                key={asset.symbol}
                clickable={asset.testnet || chain?.network === 'fvm' || !chain}
                hide={asset.hide}
              >
                <div className="top">
                  ...
                  <div>
                    <p className="head">
                      ...
                      {!isSSR && chain?.network !== 'fvm' && !asset.testnet && chain ? (
      ...
      <Container>
        <div className='text-right text-[32px] py-4'>Commodites & Index Market</div>
        <Boxes>
          {homepageCommoditySymbols.map(commodity => {
            return (
              <Box
                ...
                clickable={commodity.testnet || chain?.network === 'fvm' || !chain}
                hide={commodity.hide}
              >
                <div className="top">
                  ...
                  <div>
                    <p className="head">
                      ...
                      {!isSSR && chain?.network !== 'fvm' && !commodity.testnet && chain ? (
                        <span>mainnet only</span>
                      ) : null}
                    </p>
      ...
      <Bottom>
        ...
        <div className="largebox">
          <div className="box">
            ...
            <p>
              Currently, FVM Finance has support for ~30 different crypto markets. In the future, it&apos;s
          ...
          <div className="box">
            ...
            <p>
              Every pricefeed on FVM Finance is from{' '}
              <a href="https://chain.link" target="_blank" rel="noreferrer">
                Chainlink
              </a>
              , a decentralized oracle network. For example, here is the fvm/USD pricefeed on Polygon
              mainnet:{' '}
              <a
                href="https://data.chain.link/polygon/mainnet/crypto-usd/fvm-usd"
                target="_blank"
                rel="noreferrer"
              >
                fvm/USD
          ...
          <div className="box hackathon">
            ...
            <p>
              FVM Finance is currently participating in the Polygon #BUIDL IT Hackathon. A link to our
